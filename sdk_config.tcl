...
proc hapara_create_functional_app {proj_name source_rep {hw_mame system_wrapper_hw_platform_0}} {
    ...
    sdk create_app_project -name slave_kernel -hwproject $hw_mame -proc group0_slave_s0 -os standalone -lang C -app {Empty Application} -bsp slave_kernel_bsp
...
proc hapara_create_opencl_app {proj_name source_repo {type Debug} {hw_mame system_wrapper_hw_platform_0}} {
    ...
    foreach app $app_name_list {
        ...
        sdk create_app_project -name $app -hwproject $hw_mame -proc group0_slave_s0 -os standalone -lang C -app {Empty Application} -bsp "${app}_bsp"
